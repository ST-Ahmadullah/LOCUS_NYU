...
public class AttendanceNotTaken {
    ...
    public void downloadAttendanceReport() throws Throwable {
        ...
        driver.findElement(By.xpath("//select[@id='attendance-select']/option[text()='Attendance Not Taken']")).click();
        driver.findElement(By.xpath("//select[@id='attendance-con-select']/option[text()='=']")).click();
        driver.findElement(By.xpath("//input[@placeholder='Number of Days']")).sendKeys("1");
